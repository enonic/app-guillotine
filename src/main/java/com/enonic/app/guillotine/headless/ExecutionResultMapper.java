...
import com.enonic.lib.graphql.MapMapper;
    ...
    implements MapSerializable
{
    ...
    private void serializeData( final MapGenerator gen )
    {
        ...
        {
            final com.enonic.lib.graphql.rx.Publisher publisherSerializable =
                new com.enonic.lib.graphql.rx.Publisher( executionResult.getData() );
    ...
    private void serializeErrors( final MapGenerator gen )
    {
        ...
        {
            gen.array( "errors" );
            executionResult.getErrors().forEach( ( error ) -> this.serializeError( gen, error ) );
            gen.end();
        }
    }
