...
public class JsonToFilterMapper
{
    ...
    private static Filters wrapInBooleanMust( final Filters filters )
    {
        ...
        return Filters.create().add( builder.build() ).build();
    }
    ...
    private static Filter createIdsFilter( final Map<String, Object> idsFilter )
    {
        ...
        return IdFilter.create().values( getStringValues( idsFilter.get( VALUES_FIELD ) ) ).build();
    }
    ...
    private static Filter createExistsFilter( final Map<String, Object> existsFilter )
    {
        ...
        return ExistsFilter.create().fieldName( existsFilter.get( FIELDNAME_FIELD ).toString() ).build();
    }
    ...
    private static Filter createNotExistsFilter( final Map<String, Object> existsFilter )
    {
        ...
        return BooleanFilter.create().mustNot(
            ExistsFilter.create().fieldName( existsFilter.get( FIELDNAME_FIELD ).toString() ).build() ).build();
    }
    ...
    private static Filter createValueFilter( final Map<String, Object> valueFilter )
    {
        ...
        final ValueFilter.Builder builder = ValueFilter.create().fieldName( valueFilter.get( FIELDNAME_FIELD ).toString() ).addAllValues(
            getValues( valueFilter.get( VALUES_FIELD ) ) );
