...
public class ContentTypesFactory
{
    ...
    public void create()
    {
        ...
        GraphQLObjectType untypedContent =
            newObject( "UntypedContent", "UntypedContent", List.of( contentInterface ), getGenericContentFields( "UntypedContent" ) );
    ...
    private void createContentObjectType( ContentType contentType, GraphQLInterfaceType contentInterface )
    {
        ...
        GraphQLObjectType contentObject = newObject( typeName, typeDescription, List.of( contentInterface ), fields );
    ...
    {
        String applicationKey = StringSanitizer.create( name.getApplicationKey().toString() );
        String localName = StringSanitizer.create( name.getLocalName() );
