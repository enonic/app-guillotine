...
final class QueryHighlightParams
{
    ...
    HighlightQuery getHighlightQuery( final Map<String, Object> highlightMap )
    {
        ...
        final Map<String, Object> propertiesMap = CastHelper.cast( highlightMap.get( "properties" ) );
        ...
        propertiesMap.forEach( ( name, propertyMap ) -> {
            final HighlightQueryProperty highlightQueryProperty = highlightPropertyFromParams( name, CastHelper.cast( propertyMap ) );
