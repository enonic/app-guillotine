...
public class InputTypesFactory
{
    ...
    private void createProcessHtmlType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "ProcessHtmlInput", "Process HTML input type", fields );
    ...
    private void createNumberRangeInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "NumberRangeInput", "Number range input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createDateRangeInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "DateRangeInput", "Date range input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createGeoPointInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "GeoPointInput", "Geo range input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createTermsAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "TermsAggregationInput", "Terms aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createStatsAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "StatsAggregationInput", "Stats aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createRangeAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "RangeAggregationInput", "Range aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createDateRangeAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "DateRangeAggregationInput", "DateRange aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createDateHistogramAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject =
            newInputObject( "DateHistogramAggregationInput", "DateHistogram aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createGeoDistanceAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "GeoDistanceAggregationInput", "GeoDistance aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createMinAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "MinAggregationInput", "MinAggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createMaxAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "MaxAggregationInput", "MaxAggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createValueCountAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "ValueCountAggregationInput", "ValueCount Aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createAggregationInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "AggregationInput", "Aggregation input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createExistsFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "ExistsFilterInput", "ExistsFilter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createNotExistsFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "NotExistsFilterInput", "NotExistsFilter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createHasValueFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "HasValueFilterInput", "HasValueFilter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createIdsFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "IdsFilterInput", "IdsFilter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createBooleanFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "BooleanFilterInput", "BooleanFilter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createFilterInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "FilterInput", "Filter input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createDslExpressionValueInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "DSLExpressionValueInput", "DSLExpressionValueInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createTermExpressionDslInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "TermDSLExpressionInput", "TermDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createLikeDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "LikeDSLExpressionInput", "LikeDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createInDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "InDSLExpressionInput", "InDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createExistsDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "ExistsDSLExpressionInput", "ExistsDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createStemmedDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "StemmedDSLExpressionInput", "StemmedDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createFulltextDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "FulltextDSLExpressionInput", "FulltextDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createNgramDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "NgramDSLExpressionInput", "NgramDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createPathMatchDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "PathMatchDSLExpressionInput", "PathMatchDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createMatchAllDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "MatchAllDSLExpressionInput", "MatchAllDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createRangeDslExpressionInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "RangeDSLExpressionInput", "RangeDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createBooleanExpressionDslInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "BooleanDSLExpressionInput", "BooleanDSLExpressionInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createQueryDslInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "QueryDSLInput", "QueryDSLInput type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createGeoPointDslInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "GeoPointSortDslInput", "GeoPoint Sort Dsl input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createSortDslInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "SortDslInput", "Sort Dsl input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createHighlightPropertiesInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "HighlightPropertiesInputType", "HighlightProperties input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
    ...
    private void createHighlightInputType()
    {
        ...
        GraphQLInputObjectType inputObject = newInputObject( "HighlightInputType", "HighlightInputType input type", fields );
        context.registerType( inputObject.getName(), inputObject );
    }
