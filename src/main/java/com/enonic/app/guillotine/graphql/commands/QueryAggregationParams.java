...
final class QueryAggregationParams
{
    ...
    public Set<AggregationQuery> getAggregations( final Map<String, Object> aggregationsMap )
    {
        ...
        aggregationsMap.forEach( ( name, aggregationQueryMap ) -> {
            final AggregationQuery aggregationQuery = aggregationQueryFromParams( name, CastHelper.cast( aggregationQueryMap ) );
    ...
    private AggregationQuery aggregationQueryFromParams( final String name, final Map<String, Object> aggregationQueryMap )
    {
        ...
        {
            final Map<String, Object> termsParamsMap = CastHelper.cast( aggregationQueryMap.get( "terms" ) );
        ...
        {
            final Map<String, Object> histogramParamsMap = CastHelper.cast( aggregationQueryMap.get( "histogram" ) );
        ...
        {
            final Map<String, Object> dateHistogramParamsMap = CastHelper.cast( aggregationQueryMap.get( "dateHistogram" ) );
        ...
        {
            final Map<String, Object> numericRangeParamsMap = CastHelper.cast( aggregationQueryMap.get( "range" ) );
        ...
        {
            final Map<String, Object> dateRangeParamsMap = CastHelper.cast( aggregationQueryMap.get( "dateRange" ) );
        ...
        {
            final Map<String, Object> statsParamsMap = CastHelper.cast( aggregationQueryMap.get( "stats" ) );
        ...
        {
            final Map<String, Object> geoDistanceParamsMap = CastHelper.cast( aggregationQueryMap.get( "geoDistance" ) );
        ...
        {
            final Map<String, Object> minParamsMap = CastHelper.cast( aggregationQueryMap.get( "min" ) );
        ...
        {
            final Map<String, Object> maxParamsMap = CastHelper.cast( aggregationQueryMap.get( "max" ) );
        ...
        {
            final Map<String, Object> valueCountParamsMap = CastHelper.cast( aggregationQueryMap.get( "count" ) );
    ...
    private void addSubAggregations( final BucketAggregationQuery.Builder aggregationQuery, final Map<String, Object> aggregationQueryMap )
    {
        ...
        {
            final Map<String, Object> aggregationsMap = CastHelper.cast( aggregationQueryMap.get( "aggregations" ) );
    ...
    private TermsAggregationQuery.Builder termsAggregationFromParams( final String name, final Map<String, Object> paramsMap )
    {
        ...
        final Integer size = Optional.ofNullable( (Number) paramsMap.get( "size" ) ).map( Number::intValue ).orElse( 10 );
        ...
        final TermsAggregationQuery.Builder builder =
            TermsAggregationQuery.create( name ).fieldName( fieldName ).size( size ).orderType( orderType ).orderDirection(
                orderDirection );
    ...
    private HistogramAggregationQuery.Builder histogramAggregationFromParams( final String name, final Map<String, Object> paramsMap )
    {
        ...
        return HistogramAggregationQuery.create( name ).fieldName( fieldName ).interval( interval ).extendedBoundMin(
            extendedBoundMin ).extendedBoundMax( extendedBoundMax ).minDocCount( mindDocCount ).order( histogramOrder );
    }
                                                                                      ...
                                                                                      final Map<String, Object> paramsMap )
    {
        ...
        return DateHistogramAggregationQuery.create( name ).fieldName( fieldName ).interval( interval ).minDocCount( mindDocCount ).format(
            format );
    }
    ...
    {
        final String fieldName = (String) paramsMap.get( "field" );
        final List<Map<String, Object>> rangeListParams = CastHelper.cast( paramsMap.getOrDefault( "ranges", emptyList() ) );
        ...
        return NumericRangeAggregationQuery.create( name ).fieldName( fieldName ).setRanges( ranges );
    }
    ...
    private DateRangeAggregationQuery.Builder dateRangeAggregationFromParams( final String name, final Map<String, Object> paramsMap )
    {
        ...
        return DateRangeAggregationQuery.create( name ).fieldName( fieldName ).setRanges( ranges ).format( format );
    }
    ...
    private GeoDistanceAggregationQuery.Builder geoDistanceAggregationFromParams( final String name, final Map<String, Object> params )
    {
        ...
        final Map<String, Object> originCoordinates = CastHelper.cast( params.getOrDefault( "origin", emptyMap() ) );
        ...
        final List<Map<String, Object>> rangeListParams = CastHelper.cast( params.getOrDefault( "ranges", emptyList() ) );
    ...
    {
        final String fieldName = (String) paramsMap.get( "field" );
        return ValueCountAggregationQuery.create( name ).fieldName( fieldName );
    }
