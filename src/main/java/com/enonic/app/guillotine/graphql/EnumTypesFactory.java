...
public class EnumTypesFactory
{
    ...
    public EnumTypesFactory( GuillotineContext guillotineContext )
    {
    ...
    {
        GraphQLEnumType enumType = newEnum( name, description, values );
        guillotineContext.registerType( enumType.getName(), enumType );
    }
}
