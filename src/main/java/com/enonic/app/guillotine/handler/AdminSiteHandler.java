    ...
    extends BaseWebHandler
{
    ...
    {
        final WebResponse response = doHandleInternal( webRequest, webResponse, webHandlerChain );
    ...
    private WebResponse doHandleInternal( final WebRequest webRequest, final WebResponse webResponse,
    ...
    private static <T> T callAsContentAdmin( final RepositoryId repositoryId, final Branch branch, final Callable<T> callable )
    {
        ...
        return ContextBuilder.from( context ).repositoryId( repositoryId ).branch( branch ).authInfo(
