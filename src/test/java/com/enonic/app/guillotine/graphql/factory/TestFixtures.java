...
public class TestFixtures
{
    public static final MixinDescriptor IMAGE_METADATA =
        MixinDescriptor.create().name( IMAGE_INFO_METADATA_NAME ).title( "Image Info" ).titleI18nKey( "media.imageInfo.displayName" ).form(
            createImageInfoXDataForm() ).build();
    ...
    public static final MixinDescriptor GPS_METADATA =
        MixinDescriptor.create().name( GPS_INFO_METADATA_NAME ).title( "Gps Info" ).titleI18nKey( "base.gpsInfo.displayName" ).form(
