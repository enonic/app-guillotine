...
public class ContentTypesVerifier
{
    ...
    private void verifyDynamicallyCreatedContentType()
    {
        ...
        assertEquals( Scalars.GraphQLString, dataType.getFieldDefinition( "myLayout" ).getType() );
    ...
    private void verifyUntypedContent()
    {
        ...
        assertEquals( "ContentPathType", getNameForGraphQLTypeReference( pathField.getArgument( "type" ).getType() ) );
