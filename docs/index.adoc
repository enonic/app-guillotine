...
At its core, Guillotine is a strongly typed GraphQL version of XP's internal https://developer.enonic.com/docs/code/stable/libraries/lib-content[JS Content API]. 
