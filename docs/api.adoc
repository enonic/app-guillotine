...
|guillotine(project: String, branch: String, siteKey: String image:v-710.svg[Guillotine 7.1.0,opts=inline], pageBaseUrl: String, mediaBaseUrl: String): <<HeadlessCms>>
