...
|query: String!
|A query string to match field value(s). Supports the set of https://developer.enonic.com/docs/xp/stable/storage/dsl#search_string_operators[operators].

|language: String!
|Content language that was used for stemming. List of https://developer.enonic.com/docs/xp/stable/storage/indexing#languages[supported languages].
