...
|guillotine(siteKey: String image:v-710.svg[Guillotine 7.1.0,opts=inline], pageBaseUrl: String): <<HeadlessCms>>
...
|attachmentUrl (download: Boolean, params: Json, mediaBaseUrl: String): String
|Attachment URL
...
|mediaBaseUrl: String
|Base URL prepended to media URLs (images and attachments) in the processed HTML. Has higher priority than the `mediaBaseUrl` configuration value.
