...
Enonic XP allows to edit images at runtime. Guillotine uses this functionnality by generating, on every image, a field "imageUrl" generating a URL pointing to a processed image.
